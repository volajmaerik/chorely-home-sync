  ...
  if (showOtpStep) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background to-muted/20 p-4">
        ...
        <div className="w-full max-w-md flex justify-center" style={{backgroundColor: "blue"}}>
    ...
    <div className="min-h-screen flex items-center bg-gradient-to-br from-background to-muted/20 p-4 sm:p-6 md:p-8 lg:p-12 mx-auto">
      ...
      <div className="w-full max-w-md lg:max-w-lg xl:max-w-xl mx-auto">
        <div className="text-center mb-8 space-y-4">
          <div className="mx-auto w-16 h-16 lg:w-20 lg:h-20 bg-gradient-to-br from-primary to-primary/80 rounded-2xl flex items-center justify-center shadow-lg p-3">
